...
export default function PartnershipStrip({ variant = 'default' }: PartnershipStripProps) {
  ...
  return (
    <section className={`relative bg-gradient-to-r from-[#420b10] via-[#801b21] to-[#4c0d12] ${isThin ? 'py-2.5 sm:py-3' : 'py-8 lg:py-10'} overflow-hidden border-y border-[#e63946]/40 shadow-[0_0_50px_rgba(150,34,40,0.4)]`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center items-center">
        {isThin ? (
          /* Sleek Laser Bridge Strip — Zero Text Wording */
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col items-center group">
              <div className="relative w-11 h-11 sm:w-13 sm:h-13 flex items-center justify-center p-1.5 rounded-xl bg-white/[0.05] border border-white/15 backdrop-blur-md shadow-[0_0_20px_rgba(255,153,51,0.25)] group-hover:scale-105 group-hover:border-[#ff9933]/60 transition-all duration-300">
                <Image
              ...
              <span className="mt-0.5 text-[9px] font-semibold tracking-[0.2em] uppercase text-red-100 group-hover:text-amber-300 transition-colors font-outfit">
                India
              </span>
            </div>

            {/* Extended Connecting Laser Energy Bridge Line */}
            <div className="relative flex-1 flex items-center gap-2 px-2 max-w-md">
              <div className="flex-1 h-[2px] bg-gradient-to-r from-[#ff9933] via-[#e63946] to-white opacity-80 shadow-[0_0_8px_#ff9933]" />
              <div className="w-2.5 h-2.5 rounded-full bg-white shadow-[0_0_10px_#ffffff] animate-ping" />
              <div className="flex-1 h-[2px] bg-gradient-to-r from-white via-[#e63946] to-[#ffcc00] opacity-80 shadow-[0_0_8px_#ffcc00]" />
            ...
            {/* Germany Emblem */}
            <div className="flex flex-col items-center group">
              <div className="relative w-11 h-11 sm:w-13 sm:h-13 flex items-center justify-center p-1.5 rounded-xl bg-white/[0.05] border border-white/15 backdrop-blur-md shadow-[0_0_20px_rgba(255,204,0,0.25)] group-hover:scale-105 group-hover:border-[#ffcc00]/60 transition-all duration-300">
                <Image
              ...
              <span className="mt-0.5 text-[9px] font-semibold tracking-[0.2em] uppercase text-red-100 group-hover:text-yellow-300 transition-colors font-outfit">
                Germany
              </span>
            </div>
          </motion.div>
